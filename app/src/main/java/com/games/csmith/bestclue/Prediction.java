...
class Prediction implements Comparable<Prediction>, Parcelable {
    private Pair<Card, Double> suspect;
    private Pair<Card, Double> weapon;
    private Pair<Card, Double> room;
    private double probability;

    private Prediction(Pair<Card, Double> suspect, Pair<Card, Double> weapon, Pair<Card, Double> room) {
